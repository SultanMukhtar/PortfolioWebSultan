...
export function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    let h = (canvas.height = Math.max(window.innerHeight, document.body.scrollHeight))
    ...
    const pri = getComputedStyle(document.documentElement).getPropertyValue("--primary")
